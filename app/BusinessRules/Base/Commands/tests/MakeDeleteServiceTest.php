...
class MakeDeleteServiceTest extends GeneratorCommand
{
  /**
   ...
   * @var string
   */
  protected $name = 'make:custom_delete_service_test';
 ...
 /**
   ...
   * @var string
   */
  protected $description = 'Create a Delete Service Test';
   ...
   * @var string
   */
  protected $type = 'DeleteServiceTest';
  ...
  {
    return  app()->path() . '/BusinessRules/Base/Commands/stubs/Tests/Services/DummyModelDeleteServiceTest.stub';
  }
