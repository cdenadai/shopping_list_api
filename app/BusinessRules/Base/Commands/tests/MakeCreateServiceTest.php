...
class MakeCreateServiceTest extends GeneratorCommand
{
  /**
   ...
   * @var string
   */
  protected $name = 'make:custom_create_service_test';
 ...
 /**
   ...
   * @var string
   */
  protected $description = 'Create a Create Service Test';
   ...
   * @var string
   */
  protected $type = 'CreateServiceTest';
  ...
  {
    return  app()->path() . '/BusinessRules/Base/Commands/stubs/Tests/Services/DummyModelCreateServiceTest.stub';
  }
