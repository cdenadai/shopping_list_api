...
class MakeCreateControllerTest extends GeneratorCommand
{
  /**
   ...
   * @var string
   */
  protected $name = 'make:custom_create_controller_test';
 ...
 /**
   ...
   * @var string
   */
  protected $description = 'Create a Create Controller Test';
   ...
   * @var string
   */
  protected $type = 'CreateControllerTest';
  ...
  {
    return  app()->path() . '/BusinessRules/Base/Commands/stubs/Tests/Controllers/DummyModelCreateControllerTest.stub';
  }
