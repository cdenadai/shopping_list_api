...
class MakeUpdateControllerTest extends GeneratorCommand
{
  /**
   ...
   * @var string
   */
  protected $name = 'make:custom_update_controller_test';
 ...
 /**
   ...
   * @var string
   */
  protected $description = 'Create a Update Controller Test';
   ...
   * @var string
   */
  protected $type = 'UpdateControllerTest';
  ...
  {
    return  app()->path() . '/BusinessRules/Base/Commands/stubs/Tests/Controllers/DummyModelUpdateControllerTest.stub';
  }
