...
class MakeGetByIdServiceTest extends GeneratorCommand
{
  /**
   ...
   * @var string
   */
  protected $name = 'make:custom_getbyid_service_test';
 ...
 /**
   ...
   * @var string
   */
  protected $description = 'Create a GetById Service Test';
   ...
   * @var string
   */
  protected $type = 'GetByIdServiceTest';
  ...
  {
    return  app()->path() . '/BusinessRules/Base/Commands/stubs/Tests/Services/DummyModelGetByIdServiceTest.stub';
  }
