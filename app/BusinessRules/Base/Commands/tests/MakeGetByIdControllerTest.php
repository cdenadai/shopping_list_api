...
class MakeGetByIdControllerTest extends GeneratorCommand
{
  /**
   ...
   * @var string
   */
  protected $name = 'make:custom_getbyid_controller_test';
 ...
 /**
   ...
   * @var string
   */
  protected $description = 'Create a GetById Controller Test';
   ...
   * @var string
   */
  protected $type = 'GetByIdControllerTest';
  ...
  {
    return  app()->path() . '/BusinessRules/Base/Commands/stubs/Tests/Controllers/DummyModelGetByIdControllerTest.stub';
  }
