...
class MakeDeleteControllerTest extends GeneratorCommand
{
  /**
   ...
   * @var string
   */
  protected $name = 'make:custom_delete_controller_test';
 ...
 /**
   ...
   * @var string
   */
  protected $description = 'Create a Delete Controller Test';
   ...
   * @var string
   */
  protected $type = 'DeleteControllerTest';
  ...
  {
    return  app()->path() . '/BusinessRules/Base/Commands/stubs/Tests/Controllers/DummyModelDeleteControllerTest.stub';
  }
