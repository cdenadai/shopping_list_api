...
class MakeGetAllServiceTest extends GeneratorCommand
{
  /**
   ...
   * @var string
   */
  protected $name = 'make:custom_getall_service_test';
 ...
 /**
   ...
   * @var string
   */
  protected $description = 'Create a GetAll Service Test';
   ...
   * @var string
   */
  protected $type = 'GetAllServiceTest';
  ...
  {
    return  app()->path() . '/BusinessRules/Base/Commands/stubs/Tests/Services/DummyModelGetAllServiceTest.stub';
  }
