...
class MakeCreateService extends GeneratorCommand
{
  /**
   ...
   * @var string
   */
  protected $name = 'make:custom_create_service';
 ...
 /**
   ...
   * @var string
   */
  protected $description = 'Create a Create Service';
  ...
  {
    return  app()->path() . '/BusinessRules/Base/Commands/stubs/DummyModelCreateService.stub';
  }
