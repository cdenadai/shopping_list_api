...
class MakeDeleteController extends GeneratorCommand
{
  /**
   ...
   * @var string
   */
  protected $name = 'make:custom_delete_controller';
 ...
 /**
   ...
   * @var string
   */
  protected $description = 'Create a Delete Controller';
   ...
   * @var string
   */
  protected $type = 'DeleteController';
  ...
  {
    return  app()->path() . '/BusinessRules/Base/Commands/stubs/DummyModelDeleteController.stub';
  }
