...
class MakeDeleteService extends GeneratorCommand
{
  /**
   ...
   * @var string
   */
  protected $name = 'make:custom_delete_service';
 ...
 /**
   ...
   * @var string
   */
  protected $description = 'Create a Delete Service';
  ...
  {
    return  app()->path() . '/BusinessRules/Base/Commands/stubs/DummyModelDeleteService.stub';
  }
