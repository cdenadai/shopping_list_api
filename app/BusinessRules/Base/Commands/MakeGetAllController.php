...
class MakeGetAllController extends GeneratorCommand
{
  /**
   ...
   * @var string
   */
  protected $name = 'make:custom_getall_controller';
 ...
 /**
   ...
   * @var string
   */
  protected $description = 'Create a GetAll Controller';
   ...
   * @var string
   */
  protected $type = 'GetAllController';
  ...
  {
    return  app()->path() . '/BusinessRules/Base/Commands/stubs/DummyModelGetAllController.stub';
  }
