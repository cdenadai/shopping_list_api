...
class MakeUpdateService extends GeneratorCommand
{
  /**
   ...
   * @var string
   */
  protected $name = 'make:custom_update_service';
 ...
 /**
   ...
   * @var string
   */
  protected $description = 'Create a Update Service';
  ...
  {
    return  app()->path() . '/BusinessRules/Base/Commands/stubs/DummyModelUpdateService.stub';
  }
