...
class MakeGetByIdService extends GeneratorCommand
{
  /**
   ...
   * @var string
   */
  protected $name = 'make:custom_getbyid_service';
 ...
 /**
   ...
   * @var string
   */
  protected $description = 'Create a GetById Service';
  ...
  {
    return  app()->path() . '/BusinessRules/Base/Commands/stubs/DummyModelGetByIdService.stub';
  }
  ...
  {
    return $rootNamespace . '\BusinessRules\DummyModel\Services';
  }
