...
class MakeCreateController extends GeneratorCommand
{
  /**
   ...
   * @var string
   */
  protected $name = 'make:custom_create_controller';
 ...
 /**
   ...
   * @var string
   */
  protected $description = 'Create a Create Controller';
   ...
   * @var string
   */
  protected $type = 'CreateController';
  ...
  {
    return  app()->path() . '/BusinessRules/Base/Commands/stubs/DummyModelCreateController.stub';
  }
