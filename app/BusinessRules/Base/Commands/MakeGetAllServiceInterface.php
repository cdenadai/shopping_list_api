...
class MakeGetAllServiceInterface extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'make:custom_getall_service_interface';
     ...
     * @var string
     */
    protected $description = 'Create a get all service interface';
    ...
    {
        return  app()->path() . '/BusinessRules/Base/Commands/stubs/IDummyModelGetAllService.stub';
    }
