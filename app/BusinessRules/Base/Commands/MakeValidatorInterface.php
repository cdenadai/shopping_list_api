...
class MakeValidatorInterface extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'make:custom_validator_interface';
     ...
     * @var string
     */
    protected $description = 'Create a validator interface';
    ...
    {
        return  app()->path() . '/BusinessRules/Base/Commands/stubs/IDummyModelValidator.stub';
    }
