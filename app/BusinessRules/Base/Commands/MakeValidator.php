...
class MakeValidator extends GeneratorCommand
{
   ...
   * @var string
   */
  protected $name = 'make:custom_validator';
 ...
 /**
   ...
   * @var string
   */
  protected $description = 'Create a Validator';
  ...
  {
    return  app()->path() . '/BusinessRules/Base/Commands/stubs/DummyModelValidator.stub';
  }
  ...
  {
    return $rootNamespace . '\BusinessRules\DummyModel\Validators';
  }
    ...
    {
        return [
            ['name', InputArgument::REQUIRED, 'The name of the validators.'],
        ];
    }
}
