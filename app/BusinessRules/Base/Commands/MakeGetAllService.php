...
class MakeGetAllService extends GeneratorCommand
{
  /**
   ...
   * @var string
   */
  protected $name = 'make:custom_getall_service';
 ...
 /**
   ...
   * @var string
   */
  protected $description = 'Create a GetAll Service';
  ...
  {
    return  app()->path() . '/BusinessRules/Base/Commands/stubs/DummyModelGetAllService.stub';
  }
