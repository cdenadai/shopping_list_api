...
class MakeGetByIdServiceInterface extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'make:custom_getbyid_service_interface';
     ...
     * @var string
     */
    protected $description = 'Create a get by id service interface';
    ...
    {
        return  app()->path() . '/BusinessRules/Base/Commands/stubs/IDummyModelGetByIdService.stub';
    }
