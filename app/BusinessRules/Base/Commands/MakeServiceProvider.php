...
class MakeServiceProvider extends GeneratorCommand
{
  /**
   ...
   * @var string
   */
  protected $name = 'make:custom_provider';
 ...
 /**
   ...
   * @var string
   */
  protected $description = 'Create a Service Provider';
  ...
  {
    return  app()->path() . '/BusinessRules/Base/Commands/stubs/DummyModelServiceProvider.stub';
  }
  ...
  {
    return $rootNamespace . '\BusinessRules\DummyModel\Providers';
  }
