...
class MakeCreateServiceInterface extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'make:custom_create_service_interface';
    ...
    {
        return  app()->path() . '/BusinessRules/Base/Commands/stubs/IDummyModelCreateService.stub';
    }
